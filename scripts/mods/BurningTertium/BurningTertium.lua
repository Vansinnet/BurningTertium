...
mod:command("bt_flames", "Roof flames: /bt_flames fire|fire2|fire3|smoke [every Nth roof 1-20], off, status.",
    function(choice, every)
        ...
        elseif choice == nil or choice == "roofs" or modes[choice] then
            ...
            mod:echo("Use /bt_flames fire|fire2|fire3|smoke [1-20], off, or status")
        end
    end)
